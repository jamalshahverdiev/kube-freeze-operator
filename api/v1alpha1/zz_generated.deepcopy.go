...
func (in *ChangeFreezeStatus) DeepCopyInto(out *ChangeFreezeStatus) {
	*out = *in
	...
	if in.GitopsLastReconcileTime != nil {
		in, out := &in.GitopsLastReconcileTime, &out.GitopsLastReconcileTime
		*out = (*in).DeepCopy()
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitOpsArgoCDSpec) DeepCopyInto(out *GitOpsArgoCDSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitOpsArgoCDSpec.
func (in *GitOpsArgoCDSpec) DeepCopy() *GitOpsArgoCDSpec {
	if in == nil {
		return nil
	}
	out := new(GitOpsArgoCDSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitOpsFluxSpec) DeepCopyInto(out *GitOpsFluxSpec) {
	*out = *in
	if in.KustomizationSelector != nil {
		in, out := &in.KustomizationSelector, &out.KustomizationSelector
		*out = new(v1.LabelSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.HelmReleaseSelector != nil {
		in, out := &in.HelmReleaseSelector, &out.HelmReleaseSelector
		*out = new(v1.LabelSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.NamespaceSelector != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitOpsFluxSpec.
func (in *GitOpsFluxSpec) DeepCopy() *GitOpsFluxSpec {
	if in == nil {
		return nil
	}
	out := new(GitOpsFluxSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GitOpsSpec) DeepCopyInto(out *GitOpsSpec) {
	*out = *in
	if in.Providers != nil {
		...
		*out = make([]GitOpsProvider, len(*in))
		copy(*out, *in)
	}
	if in.ArgoCD != nil {
