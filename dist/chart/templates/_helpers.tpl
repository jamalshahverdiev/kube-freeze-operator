...
*/}}
{{- define "kube-freeze-operator.name" -}}
...
*/}}
{{- define "kube-freeze-operator.fullname" -}}
...
*/}}
{{- define "kube-freeze-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "kube-freeze-operator.resourceName" -}}
{{- $fullname := include "kube-freeze-operator.fullname" .context }}
{{- $suffix := .suffix }}
